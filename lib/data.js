...
const APTS = [
  { id: 1, t: '08:30', nm: 'Rex',   own: 'M. Dupont',    rsn: 'Contrôle diabète',         av: 'dog',    st: 'ok',   vet: 'Dr. Laurent Dubreuil', dur: 30 },
  { id: 2, t: '09:15', nm: 'Mina',  own: 'Mme Bernard',  rsn: 'Vaccination leucose',      av: 'cat',    st: 'ok',   vet: 'Dr. Laurent Dubreuil', dur: 20 },
  { id: 3, t: '10:00', nm: 'Coco',  own: 'M. Lefevre',   rsn: 'Contrôle respiratoire',    av: 'bird',   st: 'wait', vet: 'Dr. Laurent Dubreuil', dur: 30 },
  { id: 4, t: '10:45', nm: 'Nuage', own: 'Mme Moreau',   rsn: 'Vérification dentaire',    av: 'rabbit', st: 'ok',   vet: 'Dr. Laurent Dubreuil', dur: 20 },
  { id: 5, t: '11:30', nm: 'Luna',  own: 'M. Garcia',    rsn: 'Bilan thyroïdien',         av: 'cat',    st: 'urg',  vet: 'Dr. Laurent Dubreuil', dur: 45 },
  { id: 6, t: '14:00', nm: 'Rocky', own: 'Mme Laurent',  rsn: 'Suivi post-op tumeur',     av: 'dog',    st: 'ok',   vet: 'Dr. Thomas Riviere', dur: 30 },
  { id: 7, t: '14:45', nm: 'Bella', own: 'M. Petit',     rsn: 'Contrôle arthrose',        av: 'dog',    st: 'wait', vet: 'Dr. Thomas Riviere', dur: 30 },
  { id: 8, t: '15:30', nm: 'Simba', own: 'Mme Dubois',   rsn: 'Suivi cystite',            av: 'cat',    st: 'ok',   vet: 'Dr. Laurent Dubreuil', dur: 30 },
  { id: 9, t: '16:15', nm: 'Rex',   own: 'M. Dupont',    rsn: 'Échographie abdominale',   av: 'dog',    st: 'urg',  vet: 'Dr. Laurent Dubreuil', dur: 60 },
];
...
const NOTIFS = [
  ...
  { id: 4, type: 'cr',   title: 'CR validé',               text: 'Compte rendu de Nuage validé par Dr. Riviere',         time: 'Il y a 2h',     unread: false },
...
const INVOICES = ((() => {
  const mk = (id, date, animal, client, animalId, status, actes, vet = 'Dr. Laurent Dubreuil') => ({
