...
// Generate a fresh photo-upload link for the given animal. The full URL is
// derived from the incoming request's Host header so the same code works on
// localhost (http) and behind the Vercel proxy (https) without env config.
