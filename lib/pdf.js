...
function createDoc() {
  return new PDFDocument({
    ...
    bufferPages: true,
    info: { Title: 'VetCopilot', Author: 'VetCopilot', Producer: 'VetCopilot' },
  });
}
...
function drawHeader(doc, { title, subtitle, date }) {
  ...
  doc.fillColor(COLORS.NAVY).font('Helvetica-Bold').fontSize(15).text('VetCopilot', MARGIN + 50, 46);
...
function drawOrdonnanceHeader(doc, { ordonnanceNum, diagnostic, date }) {
  ...
  doc.fillColor(COLORS.NAVY).font('Helvetica-Bold').fontSize(16).text('VetCopilot', groupX + logoSize + 12, topY + 9, { lineBreak: false });
...
//   Dr. Laurent Dubreuil                            ........... dotted line ...........
//   N° Ordre : 75-12345
...
function drawSignatureBlock(doc, { vet, ordreNum }) {
  ...
  doc.fillColor(COLORS.TXT).font('Helvetica-Bold').fontSize(11)
    .text(safeText(vet || 'Dr. Laurent Dubreuil'), MARGIN, y0 + 12, { lineBreak: false });
  doc.fillColor(COLORS.TXT2).font('Helvetica').fontSize(8.5)
